...
// $_GET
// $_POST
// GETはアドレスバーに表示され、POSTはされない

// echo '<pre>';
// var_dump ($_POST);
// echo '<pre>';

// 入力、確認、完了 input.php, confirm.php, thanks.php 3種類作る
// input.php のみ
...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-contrrol" id="your_name" name="your_name" value="<?php echo h($_POST['your_name']); ?>" required>
        </div>

        <div class="form-group">
            <label for="email">メールアドレス</label>
            <input type="email" class="form-contrrol" id="email" name="email" value="<?php echo h($_POST['email']); ?>" required>
        </div>

        <div class="form-group">
            <label for="url">ホームページ</label>
            <input type="url" class="form-contrrol" id="url" name="url" value="<?php echo h($_POST['url']); ?>">
        </div>
...
<?php require '../mainte/03insert.php';
